...
return name},isArray:function(value){return value&&typeof value==='object'&&value.constructor===Array},isString:(value)=>typeof value==='string'||value instanceof String,ev:(ev,mode)=>ev.target.attributes[mode].nodeValue}
...
this.update()
return!0},deleteProperty:function(target,key){if(key in target){delete target[key];console.log(`Removed key: ${ key }`);this.update()}
return!0},update(){for(index in DATA)this.keys[index]=index
