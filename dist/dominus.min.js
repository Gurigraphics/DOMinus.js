...
this.update()},deleteProperty:function(target,key){if(key in target){delete target[key];console.log(`Removed key: ${ key }`);this.update()}},update(){for(index in DATA)this.keys[index]=index
