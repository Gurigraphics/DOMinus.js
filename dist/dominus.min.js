...
var MOD={emptyElements:["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],h:(data)=>(UTILS.isArray(data))?MOD.mountMap(data):data?MOD.mount(data):0,mount(data){!data.tag?data.tag="div":0
var el="<"+data.tag
...
target.id?this.elementChanged(target.id):value.id?this.elementChanged(value.id):0
